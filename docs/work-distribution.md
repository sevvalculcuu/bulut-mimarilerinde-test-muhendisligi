...
|--------------------|--------------|--------------|
| REST endpoint'ler | Yusuf | Şevval |
| DB modelleri | Şevval | Yusuf |
| Docker + compose | Şevval | - |
| K8s manifestleri | Şevval | - |
| Helm chart | Yusuf | - |
| KEDA autoscaling | Yusuf | - |
| ArgoCD GitOps | Yusuf | - |
| GitHub Actions | Yusuf | - |
| Monitoring (Prometheus & Grafana) | Şevval | - |
| OpenTelemetry Tracing | Yusuf | - |
| E2E testler (Playwright) | Yusuf | - |
| Performans (k6) | Şevval | - |
